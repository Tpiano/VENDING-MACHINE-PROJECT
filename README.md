...
## Data Cleaning
I simply removed some rows irrelevant to the visualization of the data, there aren't so much null values. i was able to fill u[p the null values with the mode for ,and mean for 
